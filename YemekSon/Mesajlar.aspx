<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Mesajlar.aspx.cs" Inherits="YemekSon.Mesajlar" %>
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="auto-style9">
        <table class="auto-style5">
            <tr>
                ...
                <td class="auto-style18"><em><strong>MESAJ LİSTESİ</strong></em></td>
            </tr>
        </table>
    </asp:Panel>
                ...
                <table class="auto-style5">
                    <tr>
                        ...
                        <td class="auto-style19">
                           <a href="MesajDetay.aspx?Mesajid=<%#Eval("Mesajid") %>"> <asp:Image ID="Image3" runat="server" Height="40px" ImageUrl="~/ikonlar/png-clipart-computer-icons-product-manuals-owner-s-manual-others-miscellaneous-angle.png" Width="40px"/></a>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
